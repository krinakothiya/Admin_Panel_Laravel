            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1 product-item {{ $key > 2 ? ' mrtop40' : '' }}">
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        ...
                        <button class="btn btn-sm text-dark p-0 add-to-cart" data-product-id="{{ $val->id }}"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</button> <!-- Added a button with class "add-to-cart" and data-product-id attribute -->
